...
set yrange [ 0.4 : * ] noreverse nowriteback  # (currently [:0.440000] )
set y2range [ * : 4.25 ] noreverse nowriteback  # (currently [3.40000:4.30000] )
set zlabel "" 
...
set table
plot "Symmetric.Power-2.dat" using 0:(H=$7)
unset table

set label 1 "Eigenvalue" at first 3500, 0.421 front
set label 2 "Entropy" at second 250, 3.6 front

set output "SymmetricPower.tex"
plot "Symmetric.Power-2.dat" using 5 with lines notitle, 0.424316 ls 2 lc -1 lw 2 notitle, "Symmetric.Power-2.dat" using 7 with lines axes x1y2 ls 1 lc -1 notitle , H ls 2 lw 2 lc -1 axes x1y2 notitle
#    EOF
