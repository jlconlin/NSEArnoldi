...
set yrange [ 0.40 : * ] noreverse nowriteback  # (currently [:0.440000] )
set y2range [ * : * ] noreverse nowriteback  # (currently [3.40000:4.30000] )
set zlabel "" 
...
H = 3.64482
set output "AsymmetricPower.tex"
plot "Asymmetric.Power.dat" using 5 with lines notitle, 0.427425 ls 2 lc -1 lw 2 notitle, "Asymmetric.Power.dat" using 7 with lines axes x1y2 ls 1 lc -1 notitle, H ls 2 lw 2 lc -1 axes x1y2 notitle
#    EOF
