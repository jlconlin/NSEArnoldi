...
set y2range [ 3.4 : 4.25 ] noreverse nowriteback  # (currently [3.40000:4.30000] )
set zlabel "" 
...
set label 1 "Eigenvalue" at first 250, 0.4275 front
set label 2 "Entropy" at second 2000, 3.75 front

meanEnt = 3.92051
set output "SymmetricArnoldi.tex"
plot "Symmetric.Arnoldi.dat" using (10*$0):22 with lines notitle, 0.424316 ls 2 lc -1 lw 2 notitle, "Symmetric.Arnoldi.dat" using (10*$0):38 with lines axes x1y2 ls 1 lc -1 notitle, meanEnt ls 2 lw 2 lc -1 axes x1y2 notitle 
